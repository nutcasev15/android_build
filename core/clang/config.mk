...
CLANG_CONFIG_EXTRA_CFLAGS := -O3 -funsafe-math-optimizations
CLANG_CONFIG_EXTRA_CONLYFLAGS := -std=gnu99 -O3 -funsafe-math-optimizations
CLANG_CONFIG_EXTRA_CPPFLAGS := -O3 -funsafe-math-optimizations
